...
type TooltipItem = (TooltipProps<number, string> & { payload?: any[] })['payload'] extends Array<infer Item> ? Item : never;
...
export interface ChartTooltipContentProps extends Omit<TooltipProps<number, string>, 'formatter'> {
  active?: boolean;
  payload?: any[];
  label?: any;
  indicator?: 'dot' | 'line';
  className?: string;
  formatter?: ChartTooltipContentFormatter | any;
